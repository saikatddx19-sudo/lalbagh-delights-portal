...
const values = [
  {
    icon: Heart,
    title: "Service",
    desc: "Dedicated to serving our community with passion and purpose.",
  },
  {
    icon: Users,
    title: "Leadership",
    desc: "Developing the next generation of compassionate, capable leaders.",
  },
  {
    icon: Target,
    title: "Impact",
    desc: "Creating meaningful, lasting change in the lives we touch.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto text-lg">
            ...
            the world's largest service organization, empowering youth since its
            founding.
          </p>
        </div>
